...
class ReportsController extends AppController {
    ...
    public function list() {
        ...
        $listService = TableRegistry::get('Services');
        $listCosts = TableRegistry::get('costs');
        $listSituation = TableRegistry::get('paids');
        ...
        $paidsLabel[0] = 'Todos';
        foreach ($allSituations as $paidSingle) {
            $idSituation = $paidSingle->id;
            $paids[$idSituation] = $paidSingle->title;
            $paidsLabel[$idSituation] = $paidSingle->title;
        }
        $this->set(compact('paids'));
        $this->set(compact('paidsLabel'));
        /* -------------------- FORMULÁRIO GET - FILTRO -------------------- */
