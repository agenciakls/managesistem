                ...
                <div class="card-body">
                    ...
                    <div class="c-chart-wrapper my-3">
                        ...
                        <div class="row my-4">
                            ...
                            <div class='col-md-5'>
                                <?php echo $this->Form->control('seller_id', ['class' => 'input-contato', 'label' => false, 'options' => $sellers, 'class' => 'form-control']); ?>
                            </div>
                            <div class="col-md-2">
...
if ($n == 0 && $sellerData) { ?>___*Rota de <?php echo $sellerData->name . ' - ' . strftime("%d/%m/%Y", strtotime($service->date)); ?>*___<?php } ?>
