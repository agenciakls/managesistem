...
<body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed <?php if ($usuarioAtual['menu_show'] == 1) { echo ' c-sidebar-lg-show '; } if ($usuarioAtual['menu_minimized'] == 1) { echo ' c-sidebar-minimized '; } ?> no-print" id="sidebar">
        ...
        <ul class="c-sidebar-nav">
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="<?= $this->Url->build(['controller' => 'services']); ?>">
            ...
            <li class="c-sidebar-nav-item">
                <a href="<?= $this->Url->build(['controller' => 'services']); ?>" class="c-sidebar-nav-link">
                    <i class="fas fa-cog c-sidebar-nav-icon"></i>
                    Serviços
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a href="<?= $this->Url->build(['controller' => 'clients']); ?>" class="c-sidebar-nav-link">
            ...
            if ($usuarioAtual['role_id'] == 1 || $usuarioAtual['role_id'] == 3 || $usuarioAtual['role_id'] == 4 || $usuarioAtual['role_id'] == 5 || $usuarioAtual['role_id'] == 6) {
                ?>
                <li class="c-sidebar-nav-item">
                    <a href="<?= $this->Url->build(['controller' => 'reports']); ?>" class="c-sidebar-nav-link">
    ...
    <div class="c-wrapper c-fixed-components">
        <header class="c-header c-header-light c-header-fixed c-header-with-subheader no-print">
            ...
            <ul class="c-header-nav d-md-down-none">
                ...
                <li class="c-header-nav-item px-3">
                    <a class="c-header-nav-link" href="<?= $this->Url->build(['controller' => 'clients']); ?>">
                        Clientes
                    </a>
                </li>
            </ul>
    ...
    <script src="<?php echo $this->Url->build('/'); ?>node_modules/@coreui/coreui/dist/js/coreui.bundle.min.js">
    </script>
    <!--[if IE]>
<!-->
    <script src="<?php echo $this->Url->build('/'); ?>node_modules/@coreui/icons/js/svgxuse.min.js">
    </script>
    <!--
<![endif]-->
    <!-- Plugins and scripts required by this view-->
    <script src="<?php echo $this->Url->build('/'); ?>node_modules/@coreui/chartjs/dist/js/coreui-chartjs.bundle.js">
    </script>
    <script src="<?php echo $this->Url->build('/'); ?>node_modules/@coreui/utils/dist/coreui-utils.js">
    </script>
