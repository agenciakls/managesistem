                        ...
                        <div class="main-content">
                            <form action="" method="get">
                                <div class="row my-4">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        <?php echo $this->Form->control('seller_id', ['label' => false, 'options' => $sellerLabel, 'class' => 'form-control', 'default' => $seller_id]); ?>
                                    </div>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        foreach ($costs as $cost) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $costCurrentSeller = $cost->seller_id;
                                                    if (isset($sellerLabel[$costCurrentSeller])) { echo $sellerLabel[$costCurrentSeller]; } else { echo '<span class="text-muted">Nenhum Representante</span>'; }
                                                    ?>
                                                </td>
                                                <td>
                                               <div class="row">
