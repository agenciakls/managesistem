                    ...
                    <div class="c-chart-wrapper my-3">
                        <div class="row my-3">
                            ...
                            if ($usuarioAtual['role_id'] == 1 || $usuarioAtual['role_id'] == 3 || $usuarioAtual['role_id'] == 4) {
                                ?>
                                <div class="col-md-6">
                                    <a href="<?= $this->Url->build(['action' => 'costs'], ['class' => 'btn mx-1 float-right']) ?>">
                                        <div class="jumbotron">
                                            <div class="p-2 text-center">
                                                <i class="fas fa-cash-register fa-3x"></i>
                                                <h3 class="my-2"><strong>Relatório de Despesas</strong></h3>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                            ...
                            ?>
                            <div class="col-md-6">
                                <a href="<?= $this->Url->build(['action' => 'person'], ['class' => 'btn mx-1 float-right']) ?>">
                                    <div class="jumbotron">
                                        <div class="p-2 text-center">
                                            <i class="fas fa-user-circle fa-3x"></i>
                                            <h3 class="my-2"><strong>Relatório Pessoal</strong></h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
