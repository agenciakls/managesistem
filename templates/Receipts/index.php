    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function(info) {
                window.location.href = '<?php echo $this->Url->build(['controller' => 'receipts', 'action' => 'view']); ?>/' + info.event.id;
            },
            eventDrop: function(info) {
                ...
                $.post('<?php echo $this->Url->build(['controller' => 'get', 'action' => 'editreceipt']); ?>', {
                    id: id,
                    date: newData,
                    technician_id
                }).done();
            ...
            events: {
                url: '<?php echo $this->Url->build(['controller' => 'get', 'action' => 'receipts']); ?>',
                failure: function() {
